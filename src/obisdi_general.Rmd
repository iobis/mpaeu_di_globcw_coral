...
As a final step, we remove the `MeasurementOrFact` column of the `dataset_filt` object, as this will be supplied to the IPT in a different file. We also remove some columns that can't be mapped to the DwC and that are not necessary.
